...
use App\Models\Operaciones\Linea_cotizacion;
...
class CotizacionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dinamica.operaciones.cotizacion.index',compact('cotizaciones'));
    }
    ...
    public function crear()
    {
        ...
        return  view('dinamica.operaciones.cotizacion.crear',compact('cotizaciones', 'lineas_cotizacion', 'equipos'));
    }
    ...
    public function guardar(Request $request)
    {
        ...
        return redirect('operaciones/cotizacion')->with('mensaje', 'Cotización creada con éxito');
    }
    ...
    public function editar($id)
    {
        ...
        $equipos= Equipo::orderBy('id')->get();
        return view('dinamica.operaciones.cotizacion.editar', compact('cotizacion','descripciones', 'subtotales', 'equipos'));
    }
    ...
    public function actualizar(Request $request, $id)
    {
        ...
        return redirect('operaciones/cotizacion')->with('mensaje', 'Cotización actualizada con éxito');
