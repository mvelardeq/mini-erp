...
class BoletaPagoController extends Controller
{
    ...
    public function crear($id,$periodo)
    {
        ...
        return view('dinamica.administracion.rrhh.boleta-pago.crearboleta',compact('trabajador','periodo','horas_nor','horas_25p','horas_35p','gastos','adelantos','costo_hora','dias_tra', 'numeros_domingo','horas_dob','dias_noc','faltas','descuentos'));
