...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-outline card-info">
            ...
            <form action="{{route('actualizar_factura', ['id' => $factura->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf @method("put")
                <div class="card-body">
                    @include('dinamica.ventas.factura.form')
                </div>
