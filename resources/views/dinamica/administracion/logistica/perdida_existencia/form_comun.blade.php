...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <select name="producto_id" id="producto_id" class="selectpicker form-control" data-live-search="true">
...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="date" name="fecha" id="fecha" class="form-control" value="{{old('fecha', $perdida->fecha ?? '')}}"/>
    </div>
</div>
<div class="form-group row">
    <label for="motivo" class="col-lg-3 col-form-label">Motivo</label>
    <div class="col-lg-8">
        <input type="text" name="motivo" id="motivo" class="form-control" value="{{old('motivo', $perdida->motivo ?? '')}}"/>
    </div>
</div>
<div class="form-group row">
    <label for="cantidad" class="col-lg-3 col-form-label">Cantidad</label>
    <div class="col-lg-8">
        <input type="number" step="0.01" name="cantidad" id="cantidad" class="form-control" value="{{old('cantidad', $perdida->cantidad ?? '')}}"/>
    </div>
</div>
