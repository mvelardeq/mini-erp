...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <select name="item_compra_id" id="item_compra_id" class="selectpicker form-control" data-live-search="true">
...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="number" step="0.01" name="cantidad" id="cantidad" class="form-control" value="1" disabled/>
    </div>
</div>
