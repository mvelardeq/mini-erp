...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-outline card-info">
            ...
            <form action="{{route('actualizar_cargo', ['id' => $cargo_trabajador->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf @method("put")
                <div class="card-body">
                    @include('dinamica.administracion.rrhh.cargo.form')
                </div>
