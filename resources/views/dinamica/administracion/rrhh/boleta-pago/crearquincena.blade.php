    ...
    <div class="col-lg-12">
        ...
        <div class="card card-outline card-info">
            <div class="card-header">
                <h3 class="card-title">Crear quincena de {{$trabajador->primer_nombre.' '.$trabajador->primer_apellido}}</h3>
                        ...
                        <div class="col-lg-8">
                            <ul class="list-group mb-3">
                                    <li class="list-group-item bg-success">
                                        <b>Sueldo Quincena</b> <b class="float-right">S/.{{number_format($costo_hora*8*15,2)}}</b>
                                    </li>
                                    <li class="list-group-item">
                                        <b class="text-muted">Dias trabajados ({{$dias_tra+$numeros_domingo+$faltas->count()}} dias)</b> <a class="float-right">S/.{{number_format(($dias_tra+$numeros_domingo+$faltas->count())*$costo_hora*8,2)}}</a>
                                    </li>
                                    <li class="list-group-item">
            ...
            <form action="{{route('guardar_quincena_trabajador',['id'=>$trabajador->id,'periodo'=>$periodo])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="nombre" class="col-lg-3 col-form-label">Pago quincena</label>
                        <div class="col-lg-8">
                            <input type="text" name="nombre" id="nombre" class="form-control" value="{{number_format($costo_hora*8*15+$horas_25p->sum('horas')*$costo_hora*1.25+$horas_35p->sum('horas')*$costo_hora*1.35+$horas_dob->sum('horas')*$costo_hora*2+$gastos->sum('pago')-$adelantos->sum('pago')-$descuentos-$faltas->count()*$costo_hora*8,2)}}"/>
                        </div>
                    </div>
