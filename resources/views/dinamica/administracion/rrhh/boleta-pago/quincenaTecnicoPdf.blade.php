...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      <h1>Quincena {{Carbon::create($periodo)->isoFormat('MMMM YYYY')}}</h1>
      <div id="project">
      ...
      <table>
        ...
        <tbody>
            @if ($dias_noc->count() - $faltas->count() > 0)
                <tr>
                    <td class="service">Sueldo quincena</td>
                    <td class="desc"></td>
                    <td>{{number_format($costo_hora * 8 * 15, 2)}}</td>
                </tr>
                <tr>
                    <td class="service">Días trabajados ({{ $dias_tra + $numeros_domingo + $faltas->count() }} dias)</td>
                    <td class="desc"></td>
            ...
            <tr>
                <td colspan="2" class="grand total">PAGO QUINCENA</td>
                <td class="grand total">S/.{{number_format($request->pago,2)}}</td>
            </tr>
            @else
                <tr>
                    <td class="service">Sueldo quincena</td>
