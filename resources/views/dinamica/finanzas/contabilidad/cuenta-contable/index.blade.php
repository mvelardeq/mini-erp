                    ...
                    <tbody>
                        @foreach ($cuentas_contable as $cuenta_contable)
                            <tr>
                                ...
                                <td>
                                    @if (isset($cuenta_contable->banco))
                                        ...
                                        @foreach ($trabajadores as $trabajador)
                                            @if ($trabajador->id == $cuenta_contable->responsable_id)
                                ...
                                <td>
                                    <a href="{{route('editar_cuenta_contable', ['id' => $cuenta_contable->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este registro">
