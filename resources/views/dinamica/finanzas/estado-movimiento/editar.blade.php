...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-outline card-info">
            ...
            <form action="{{route('actualizar_pago_servicio', ['id' => $pago_servicio->id])}}" id="form-general" class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf @method("put")
                <div class="card-body">
